...
#eCV5546 max firmware size, ID-RAM(256K) - resource_table(1K)
...
CCFLAGS += -I$(TOP)/system/drivers/CMSIS/Device/eys3d/ecv5546/Include
CCFLAGS += -I$(TOP)/system/drivers/CMSIS/Device/eys3d/ecv5546/Source/gcc
CCFLAGS += -I$(TOP)/system/drivers/CMSIS/CMSIS/Core_CM4/Include

#HAL header files
CCFLAGS += -I$(TOP)/system/drivers/ecv5546_hal_driver/inc
CCFLAGS += -I$(TOP)/system/ecv5546

#libraries srcwarpper header files for Arduino Framework
CCFLAGS += -I$(TOP)/system/drivers/ecv5546_hal_driver/src
CCFLAGS += -I$(TOP)/libraries/DriverWrapper/src
CCFLAGS += -I$(TOP)/libraries/DriverWrapper/src/eys3d
...
CCFLAGS += -I$(TOP)/cores/arduino/eys3d
CCFLAGS += -I$(TOP)/cores/arduino/eys3d/hal
CCFLAGS += -I$(TOP)/cores/arduino/eys3d/LL
CCFLAGS += -I$(TOP)/cores/arduino/eys3d/LL
CCFLAGS += -I$(TOP)/variants/ecv5546_evb

# C Sources Files Directory
#DIRS += $(TOP)/system/ecv5546
DIRS += $(TOP)/libraries/DriverWrapper/src
DIRS += $(TOP)/libraries/DriverWrapper/src/HAL
DIRS += $(TOP)/libraries/DriverWrapper/src/eys3d
